package com.undef.manosLocalesCernikGaribaldi.activities.ui.theme
...
val FontMontserratLight = FontFamily(
    Font(R.font.montserratlight) // usa el nombre exacto del archivo .ttf (sin extensión en el recurso)
)